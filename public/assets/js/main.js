...
},{"../../components/RecentBuilds.jsx":3,"../../data/recentBuilds.js":4,"react":162,"react-dom":33}],3:[function(require,module,exports){
"use strict";
    ...
    render: function render() {
        return React.createElement(
            ...
            this.props.companies.map(function (company) {
                return React.createElement(Company, { key: company.id, name: company.name, uri: company.uri, logo: company.logo });
            })
        );
    }
});
...
Company = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            "a",
            { href: this.props.uri, target: "_blank" },
            React.createElement("img", { src: this.props.logo, alt: this.props.name })
        );
    }
});
...
var recentBuilds = [{
    ...
    uri: 'http://www.msi-europe.com',
    logo: '/assets/images/recent-builds/msi-europe/msi-europe-logo.gif'
}, {
    id: 5,
    name: 'The Ludus Project',
    uri: 'http://www.theludusproject.com',
    logo: '/assets/images/recent-builds/tlp/tlp-logo.gif'
}, {
    id: 4,
    name: 'Coffee Bird',
    uri: 'http://www.coffee-bird.com',
    logo: '/assets/images/recent-builds/coffee-bird/coffee-bird-logo.gif'
}, {
    id: 3,
    name: 'AC PLC',
    uri: 'http://www.acplc.net',
    logo: '/assets/images/recent-builds/ac-plc/ac-plc-logo.gif'
}, {
    id: 2,
    name: 'Elliott & Tate',
    uri: 'http://www.elliottandtate.com',
    logo: '/assets/images/recent-builds/eat/elliott-and-tate-logo.gif'
}, {
    id: 1,
    name: 'Great Plains',
    uri: 'http://www.greatplains.co.uk',
    logo: '/assets/images/recent-builds/great-plains/great-plains-logo.gif'
}, {
    id: 0,
    name: 'Adviser Vision',
    uri: 'ttp://www.adviservision.tv',
    logo: '/assets/images/recent-builds/av/adviser-vision-logo.gif'
}];
